...
if(mysqli_connect_errno()){
    ...
    $selectQuery =  "SELECT fine.fine,fine.Fine_date,fine.person, fine.cost,person.Name, fine.Status from fine join person on fine.person=person.id where person.id='".$id."' and Status='no';";
...
?>
                ...
                <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Incomplete Payments</h6>
