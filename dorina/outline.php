...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3" class="dont">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="car.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
        ...
        <div class="content" >
            <!-- Navbar Start -->
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0" class="dont">
                ...
                <form class="d-none d-md-flex ms-4" method="post" action="search.php"> 
                    <input id=t2 class="form-control bg-dark border-0" type="search" placeholder="Search">
